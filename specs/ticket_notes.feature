Feature: Ticket Notes
  ...
  Scenario: Add a note to ticket
    When I run "ko note note-0001 'This is my note'"
  ...
  Scenario: Note has timestamp
    When I run "ko note note-0001 'Timestamped note'"
    Then the command should succeed
    And ticket "note-0001" should contain a timestamp in notes

  Scenario: Add multiple notes
    When I run "ko note note-0001 'First note'"
    And I run "ko note note-0001 'Second note'"
  ...
  Scenario: Empty stdin falls back to args
    When I run "ko note note-0001 'From command line'" with no stdin
    Then the command should succeed
