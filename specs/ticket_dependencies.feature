Feature: Ticket Dependencies
  ...
  Scenario: Add a dependency
    When I run "ko dep task-0001 task-0002"
  ...
  Scenario: Remove a dependency
    Given ticket "task-0001" depends on "task-0002"
    When I run "ko undep task-0001 task-0002"
    Then the command should succeed
  ...
  Scenario: View dependency tree
    ...
    When I run "ko dep tree task-0001"
    Then the command should succeed
  ...
  Scenario: Self-dependency is rejected
    When I run "ko dep task-0001 task-0001"
    Then the command should fail
    And the error should contain "cannot depend on itself"
