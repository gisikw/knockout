...
The implementation was missing spec and testscript coverage for the new shorthand — an invariant violation (every behavior must have a spec; every spec must have a testscript test). Fixed:
